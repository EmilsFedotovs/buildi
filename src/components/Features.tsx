...
import { Search, DollarSign, Shield, Zap, Users, FileText, Clock, CheckCircle, Star } from "lucide-react";
const Features = () => {
  const features = [{
    icon: Search,
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="bg-gradient-subtle rounded-2xl p-8 lg:p-12">
          <div className="text-center mb-12">
            <h3 className="text-2xl lg:text-3xl font-bold mb-4">Why Choose Buildi?</h3>
